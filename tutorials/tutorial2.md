...
Dans ce jeu assez simple jouable sur un navigateur, le joueur-serpent
(unique !) se déplace pour manger des pommes, fruits du péché comme
chacun sait. En l'occurrence quand le serpent passe sur une pomme, il
grandit.  La figure ![suivante](./snake.png) donne une idée de ce que
vous allez devoir coder.

Le plateau (en bleu) contient des pommes (en vert), et le serpent apparaît en rouge.

Remarque : Nous considérerons en pratique que l'unité de base est la
...
une case d'épaisseur ; une pomme fait exactement une case, la forme
rêvée pour l'industrie agro-alimentaire.
...
`<body>`. [Une explication sur cet
attribut.](http://www.w3schools.com/jsref/event_onload.asp)
